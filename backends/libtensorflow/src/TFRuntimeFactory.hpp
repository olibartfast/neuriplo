...
// Abstract Factory for the TensorFlow runtime family: pairs the TFDetectionAPI
// adapter with the default host allocator and tensor converter.
class TFRuntimeFactory : public IBackendRuntimeFactory {
  public:
    ...
    const char* name() const noexcept override { return "TFRuntimeFactory"; }
};
