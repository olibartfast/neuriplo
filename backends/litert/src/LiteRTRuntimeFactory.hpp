...
// Abstract Factory for the LiteRT runtime family: pairs the LiteRTInfer adapter
// with the default host allocator and tensor converter.
class LiteRTRuntimeFactory : public IBackendRuntimeFactory {
  public:
    ...
    const char* name() const noexcept override { return "LiteRTRuntimeFactory"; }
};
