...
// Abstract Factory for the LibTorch runtime family: pairs the LibtorchInfer
// adapter with the default host allocator and tensor converter.
class LibtorchRuntimeFactory : public IBackendRuntimeFactory {
  public:
    ...
    const char* name() const noexcept override { return "LibtorchRuntimeFactory"; }
};
