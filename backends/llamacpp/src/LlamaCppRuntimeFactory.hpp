...
// Abstract Factory for the llama.cpp runtime family: pairs the LlamaCppInfer
// adapter with the default host allocator and tensor converter.
class LlamaCppRuntimeFactory : public IBackendRuntimeFactory {
  public:
    ...
    const char* name() const noexcept override { return "LlamaCppRuntimeFactory"; }
};
